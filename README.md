...
<body class="skin-simplememory no-navbar" style="overflow: auto;"><div id="MathJax_Message" style="display: none;"></div><p>&lt;!DOCTYPE html&gt;</p>
    ...
    <link id="favicon" rel="shortcut icon" href="https://im-shenfandog.github.io/ico.svg" type="image/svg+xml">
...
<div id="MathJax_Message" style="display: none;"></div><div id="pageAnimationOffOn" data="off"><span id="pageAnimationOffOnIcon" class="iconfont icon-shandian"></span><span id="pageAnimationOffOnText">隐藏页面特效</span></div><div id="MathJax_Message" style="display: none;"></div>
